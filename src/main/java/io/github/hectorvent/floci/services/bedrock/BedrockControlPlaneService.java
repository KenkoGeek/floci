...
public class BedrockControlPlaneService implements Resettable {
    ...
    public synchronized Result execute(String operation, ObjectNode request,
        ...
        Result result = switch (operation) {
            ...
            case "StopAdvancedPromptOptimizationJob" -> stopGeneric("advanced-prompt-optimization-job", path.get("jobIdentifier"), region);
            case "BatchDeleteAdvancedPromptOptimizationJob" -> batchDeleteJobs("advanced-prompt-optimization-job", request, region, "advancedPromptOptimizationJobs");
            case "CreateAutomatedReasoningPolicy" -> createAutomatedReasoningPolicy(request, region);
            case "GetAutomatedReasoningPolicy" -> getGeneric("automated-reasoning-policy", path.get("policyArn"), region);
            case "ListAutomatedReasoningPolicies" -> listGeneric("automated-reasoning-policy", "automatedReasoningPolicySummaries", region);
            case "UpdateAutomatedReasoningPolicy" -> updateAutomatedReasoningPolicy(path.get("policyArn"), request, region);
            ...
            case "UpdateAutomatedReasoningPolicyTestCase" -> updateAutomatedReasoningPolicyTestCase(path.get("policyArn"), path.get("testCaseId"), request, region);
            case "DeleteAutomatedReasoningPolicyTestCase" -> deleteAutomatedReasoningPolicyTestCase(path.get("policyArn"), path.get("testCaseId"), region);
            case "CreateAutomatedReasoningPolicyVersion" -> createAutomatedReasoningPolicyVersion(path.get("policyArn"), request, region);
            case "ExportAutomatedReasoningPolicyVersion" -> exportAutomatedReasoningPolicyVersion(path.get("policyArn"), region);
