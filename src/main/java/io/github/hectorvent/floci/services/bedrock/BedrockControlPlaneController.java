...
public class BedrockControlPlaneController {
    ...
    @GET
    @Path("/automated-reasoning-policies/{policyArn:.+}/test-cases")
    public Response listAutomatedReasoningPolicyTestCases(@PathParam("policyArn") String policyArn, @Context HttpHeaders headers) {
        return execute("ListAutomatedReasoningPolicyTestCases", null, Map.of("policyArn", policyArn), headers);
    }

    @PATCH
    @Path("/automated-reasoning-policies/{policyArn:.+}/test-cases/{testCaseId:.+}")
    public Response updateAutomatedReasoningPolicyTestCase(@PathParam("policyArn") String policyArn, @PathParam("testCaseId") String testCaseId, String body, @Context HttpHeaders headers) {
        return execute("UpdateAutomatedReasoningPolicyTestCase", body, Map.of("policyArn", policyArn, "testCaseId", testCaseId), headers);
    }

    @DELETE
    @Path("/automated-reasoning-policies/{policyArn:.+}/test-cases/{testCaseId:.+}")
    public Response deleteAutomatedReasoningPolicyTestCase(@PathParam("policyArn") String policyArn, @PathParam("testCaseId") String testCaseId, @Context HttpHeaders headers) {
        return execute("DeleteAutomatedReasoningPolicyTestCase", null, Map.of("policyArn", policyArn, "testCaseId", testCaseId), headers);
    }

    @POST
    @Path("/automated-reasoning-policies/{policyArn:.+}/versions")
    public Response createAutomatedReasoningPolicyVersion(@PathParam("policyArn") String policyArn, String body, @Context HttpHeaders headers) {
        return execute("CreateAutomatedReasoningPolicyVersion", body, Map.of("policyArn", policyArn), headers);
    }

    @GET
    @Path("/automated-reasoning-policies/{policyArn:.+}/export")
    public Response exportAutomatedReasoningPolicyVersion(@PathParam("policyArn") String policyArn, @Context HttpHeaders headers) {
        return execute("ExportAutomatedReasoningPolicyVersion", null, Map.of("policyArn", policyArn), headers);
    }
