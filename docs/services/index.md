...
| [Control Tower](controltower.md) | `/list-landingzones`, `/get-landingzone`, `/create-landingzone`, `/*-baseline*`, `/*-enabled-control*`, `/enable-control`, `/reset-enabled-control` | REST JSON | 21 |
