...
| BR-051 | `StopModelCustomizationJob` | `POST /model-customization-jobs/{jobIdentifier}/stop` | SDK marshaller binding verified; diff-check |
| BR-052 | `CreateModelCopyJob` | `POST /model-copy-jobs` | SDK marshaller binding verified; diff-check |
| BR-053 | `GetModelCopyJob` | `GET /model-copy-jobs/{jobArn}` | SDK marshaller binding verified; diff-check |
...
| BR-058 | `StopModelInvocationJob` | `POST /model-invocation-job/{jobIdentifier}/stop` | SDK marshaller binding verified; diff-check |
| BR-059 | `CreateMarketplaceModelEndpoint` | `POST /marketplace-model/endpoints` | SDK marshaller binding verified; diff-check |
| BR-060 | `GetMarketplaceModelEndpoint` | `GET /marketplace-model/endpoints/{endpointArn}` | SDK marshaller binding verified; diff-check |
...
| BR-065 | `DeregisterMarketplaceModelEndpoint` | `DELETE /marketplace-model/endpoints/{endpointArn}/registration` | SDK marshaller binding verified; diff-check |
| BR-066 | `CreatePromptRouter` | `POST /prompt-routers` | SDK marshaller binding verified; diff-check |
